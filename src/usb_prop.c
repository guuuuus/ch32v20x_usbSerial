...
uint8_t cdc_comconfig[8] = {(uint8_t)(DEF_UARTx_BAUDRATE), (uint8_t)(DEF_UARTx_BAUDRATE >> 8), (uint8_t)(DEF_UARTx_BAUDRATE >> 16), (uint8_t)(DEF_UARTx_BAUDRATE >> 24), DEF_UARTx_STOPBIT, DEF_UARTx_PARITY, DEF_UARTx_DATABIT, DEF_UARTx_RX_TIMEOUT};
